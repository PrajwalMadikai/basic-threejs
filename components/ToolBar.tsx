...
export default function ToolBar({
  ...
  return (
    ...
    <div className="fixed bottom-6 left-1/2 transform -translate-x-1/2 w-[650px] flex justify-center items-center gap-4 bg-gray-800 p-3 rounded-full shadow-lg border border-gray-700">     <button
      ...
      <div className="mx-1 w-px h-8 bg-gray-600 self-center"></div>
  
      <button
        onClick={clearAll}
        className="flex items-center gap-2 px-4 py-2.5 bg-red-500 text-white rounded-md hover:bg-red-600 transition-colors font-medium"
      >
